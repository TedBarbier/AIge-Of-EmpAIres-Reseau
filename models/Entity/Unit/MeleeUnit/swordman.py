...
class SwordMan(MeleeUnit):
    ...
    def __init__(self,id_gen, cell_Y, cell_X, position, team, representation = 's', hp = 40, cost = {"gold":20,"wood":0,"food":50}, training_time = 20, speed = 0.9, attack = 4, attack_speed = 0.9, id=None):
